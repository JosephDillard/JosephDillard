...
Recent additions: [Four recent projects](https://josephdillard.github.io/JosephDillard/recent-projects/) — ArcGIS Enterprise Capacity Planning Model, OSINT Source Library, Open GEOINT Watch, and Atlas / AI Brain. The page includes public descriptions and labels the two private repository links as requiring access.
